/**
 * Canonical menu — edited via admin + menu-config.json (hidden / additions).
 * Do not import app.js here.
 */
window.BASE_DRINKS = {
  matcha: [
  ...
  jasmine: [
    ...
    { id: 'jgam', name: 'Green Apple Mango Jasmine Tea', desc: 'Jasmine green tea with green apple, mango jelly, and boba', emoji: '🍏' },
  ],
  other_tea: [
